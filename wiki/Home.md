...
Features
===
   * [Pre-requisites and System Requirements](https://github.com/authorjapps/zerocode/wiki/Pre%E2%80%90requisites-and-System-Requirements)
...
* [File upload using HTTP API](https://github.com/authorjapps/zerocode/wiki/File-Upload-Using-Http-API-Automated-Testing)
...
+ [XML escape double quotes for SOAP](https://www.freeformatter.com/java-dotnet-escape.html#ad-output)
