...
## Disabling Report Generation During Large Scale Load Testing
```
...
Mainly due to the fact that, report generation (large scale) is a time and resource/memory consuming tasks.
