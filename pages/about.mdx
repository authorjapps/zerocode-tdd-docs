...
but sometimes our collaborators are busy in their respective day jobs which might add few days of delay.
...
This documentation site was created by [N. Chandra](https://www.linkedin.com/in/ncnayak/).

P.S.
If you're maintaining an opensource project and looking to create a similar documentation site, then feel free to get in touch for a quick overview on how to create and organize your MD/MDX contents.
